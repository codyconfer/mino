...
func newRestoreCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		Long: "Decrypts a `mino backup` file using the key escrowed in your secret manager\n" +
	...
	c.Flags().StringVar(&dest, "dest", "", "destination directory (default: <mino home>/.data)")
