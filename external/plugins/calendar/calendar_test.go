...
func TestEventToItem_Timed(t *testing.T) {
	ev := &calapi.Event{
		...
		Organizer:   &calapi.EventOrganizer{Email: "lead@example.com"},
		Start:       &calapi.EventDateTime{DateTime: "2026-07-22T09:30:00-04:00"},
	}
...
func TestEventToItem_AllDay(t *testing.T) {
	ev := &calapi.Event{
		...
		Start:   &calapi.EventDateTime{Date: "2026-12-25"},
	}
...
func TestEventToItem_NilStart(t *testing.T) {
	ev := &calapi.Event{Summary: "No time"}
