...
func renderPluginGo(pkg, id, signal string) string {
	...
	return fmt.Sprintf(`// Code generated by mino plugins scaffold; edit as needed.
package %s
...
func renderQueryYAML(signal string) string {
	return fmt.Sprintf(`# Example query seed — copy anywhere under the mino home, or RegisterSeeds.
name: %s-ping
type: query
signal: %s
params: {}
