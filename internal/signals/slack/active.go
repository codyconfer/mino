...
func NewActive(botToken, appToken string) signals.ActiveSignal {
...
func (h *activeSlack) Stream(ctx context.Context) (<-chan signals.Event, error) {
...
func activeItem(me *slackevents.MessageEvent) (signals.Item, bool) {
	switch me.SubType {
