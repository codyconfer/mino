...
func (m *Menu) Update(a *State, msg tea.Msg) tea.Cmd {
...
func renderIcon(icon string, hue int) string { return theme.Icon(icon, hue) }
...
func (c *Content) Update(a *State, msg tea.Msg) tea.Cmd {
	switch m := msg.(type) {
...
func (m *Message) Update(a *State, msg tea.Msg) tea.Cmd {
